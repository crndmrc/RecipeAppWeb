...
class Recipe {
  ...
  factory Recipe.fromJson(Map<String, dynamic> json) => Recipe(
    ...
    mealType: json["mealType"] == null ? null : List<String>.from(json["mealType"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "totalTime": totalTime,
    "cuisineType": cuisineType == null ? null : List<dynamic>.from(cuisineType.map((x) => x)),
    "mealType": mealType == null ? null : List<dynamic>.from(mealType.map((x) => x)),
    "dishType": dishType == null ? null : List<dynamic>.from(dishType.map((x) => x)),
